    ...
    public partial struct SamplePlayerInput : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
                         ...
                         .WithAll<GhostOwnerIsLocal>())
            {
                ...
                // Sync camera to look
                if (playerController.isVrPlayer())
                {
                    // MultiplayPlayerControllerVR playerControllerVR = ((MultiplayPlayerControllerVR)playerController);
                    // input.ValueRW.Pitch = playerControllerVR.inputLookVR.eulerAngles.y;
                    // input.ValueRW.Yaw = playerControllerVR.inputLookVR.eulerAngles.z;
                    // playerObj.transform.rotation = playerControllerVR.inputLookVR;
